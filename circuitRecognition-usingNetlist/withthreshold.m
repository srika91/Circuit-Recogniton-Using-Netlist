 ...
 i1=imread('C:\Users\kalki\Downloads\20130326_131933_1.jpg');
% %i1=imcrop(i1);
% %se=strel('diamond',2);
...
for i=2:1:511
    ...
    for j=2:1:511
        if(i5(i,j)==1)
            ...
            leftnode=[i j];
            dlmwrite('testing7\leftnode.txt',leftnode,'-append', ...
             'newline', 'pc');
            end
            if(i5(i,j+1)==1 && i5(i,j-1)==0 && i5(i-1,j-1)==0  && i5(i-1,j)==0 && i5(i-1,j+1)==0 && i5(i+1,j-1)==0 && i5(i+1,j)==0 && i5(i+1,j+1)==0)
            rightnode=[i j];
            dlmwrite('testing7\rightnode.txt',rightnode,'-append', ...
             'newline', 'pc');
            end
...
if(exist('testing7\leftnode.txt') && exist('testing7\rightnode.txt'))
left=csvread('testing7\leftnode.txt');
right=csvread('testing7\rightnode.txt');
[r c]=size(left);
if(r>1)
    k=[];
...
k(i,j)=sqrt((abs(x1-x2).^2) + (abs(y1-y2).^2));
 ...
 leftu=[left(i,1) left(i,2)];
            dlmwrite('testing7\corresLEFT.txt',leftu,'-append', ...
              'newline', 'pc');

 rightu=[right(y,1) right(y,2)];
            dlmwrite('testing7\corresRIGHT.txt',rightu,'-append', ...
              'newline', 'pc');
 
 end
end
end
 if(exist('testing7\upnode.txt') && exist('testing7\downnode.txt'))
 up=csvread('testing7\upnode.txt');

down=csvread('testing7\downnode.txt');
[r1 c1]=size(up);
if(r1>1)
    k=[];
 for i=1:1:length(up)
...
k(i,j)=sqrt((abs(x1-x2).^2) + (abs(y1-y2).^2));
 ...
 [x,y]=find(k==mini);
 upu=[up(i,1) up(i,2)];
            dlmwrite('testing7\corresup.txt',upu,'-append', ...
              'newline', 'pc');

 downu=[down(y,1) down(y,2)];
            dlmwrite('testing7\corresdown.txt',downu,'-append', ...
              'newline', 'pc');
...
if(r>1 && exist('testing7\corresLEFT.txt'))
left1=csvread('testing7\corresLEFT.txt');
...
for i=1:1:length(left1)
    ...
    for j=1:1:length(statsqq)
        ...
        for k=1:1:length(statsqq(j).PixelList)
            ...
            if((x2==x1) && (y2==y1))
                %disp(y2);
                dlmwrite('testing7\mergedleftnode.txt',j,'-append', ...
              'newline', 'pc');  
            end
        end
    end
end
if(exist('testing7\corresRIGHT.txt'))
right1=csvread('testing7\corresRIGHT.txt');
...
for i=1:1:length(right1)
    ...
    for j=1:1:length(statsqq)
        ...
        for k=1:1:length(statsqq(j).PixelList)
            ...
            if((x2==x1) && (y2==y1))
                %disp(y2);
                dlmwrite('testing7\mergedrightnode.txt',j,'-append', ...
              'newline', 'pc');  
            end
        end
    end
...
if(r1>1 && exist('testing7\corresup.txt'))
up1=csvread('testing7\corresup.txt');
...
for i=1:1:length(up1)
    ...
    for j=1:1:length(statsqq)
        ...
        for k=1:1:length(statsqq(j).PixelList)
            ...
            if((x2==x1) && (y2==y1))
                %disp(y2);
                dlmwrite('testing7\mergedupnode.txt',j,'-append', ...
              'newline', 'pc');  
            end
        end
    end
end
if(exist('testing7\corresdown.txt'))
down1=csvread('testing7\corresdown.txt');
...
for i=1:1:length(down1)
    ...
    for j=1:1:length(statsqq)
        ...
        for k=1:1:length(statsqq(j).PixelList)
            ...
            if((x2==x1) && (y2==y1))
                %disp(y2);
                dlmwrite('testing7\mergeddownnode.txt',j,'-append', ...
              'newline', 'pc');  
            end
        end
    end
...
if(r1==1 && exist('testing7\downnode.txt'))
    down=csvread('testing7\downnode.txt');
    aa=bwconncomp(i5);
L = labelmatrix(aa);
RGB = label2rgb(L);
...
if(exist('testing7\leftnode.txt'))
left=csvread('testing7\leftnode.txt');
[r c]=size(left);
if(r==1)
...
if(exist('testing7\rightnode.txt'))
right=csvread('testing7\rightnode.txt');
%if(length(right)==1)
    aa=bwconncomp(i5);
L = labelmatrix(aa);
...
if(exist('testing7\leftnode.txt'))
[r c]=size(csvread('testing7\leftnode.txt'));
end
CC=bwconncomp(i7);
...
if(r==1 && exist('testing7\leftnode.txt'))
 m1=csvread('testing7\leftnode.txt');
% m1=m1(2,:);
end
 if( r~=1 && exist('testing7\corresLEFT.txt'))
     m1=csvread('testing7\corresLEFT.txt');
 end
 ...
 yy(ii,1)=dist(xd,2);
    ...
    for i=1:1:length(centroid)
        ...
        if(sq(j,1)<40 && sq(j,1)~=0)
            xl=[yy(ii,1) i];
            dlmwrite('testing7\centroidseqleft.txt',xl,'-append', ...
              'newline', 'pc');
            yy(ii,1)=i;
        end
        j=j+1;
...
% m1=[];
 if(exist('testing7\upnode.txt'))
 [r1 c1]=size(csvread('testing7\upnode.txt'));
 end
 if(r1==1 && exist('testing7\upnode.txt'))
 m1=csvread('testing7\upnode.txt');
% m1=m1(2,:);
 end
 if(r1~=1 && exist('testing7\corresup.txt'))
     m1=csvread('testing7\corresup.txt');
 end
 if(exist('m1'))
  [xm,ym]=size(m1);
    ...
    for i=1:1:length(centroid)
     ...
     for i=1:1:length(centroid)
        ...
        if(sq(jj,1)<40 && sq(jj,1)~=0)
            xu=[xx(ii,1) i];
            dlmwrite('testing7\centroidsequp.txt',xu,'-append', ...
              'newline', 'pc');
            xx(ii,1)=i;
        end
        jj=jj+1;
 ...
 if(exist('testing7\centroidseqleft.txt'))
obleft=csvread('testing7\centroidseqleft.txt');
...
ar1=[];
    for j=1:1:vxz(1)
        ...
        ar1=unique(ar1(:));
        ar1(ar1==0)=[];
 dlmwrite('testing7\leftobj.txt',ar1','-append', ...
              'newline', 'pc');       
if(length(vxz)>1)    
ar2=[];
...
%        disp(g);
        ...
        ar2=unique(ar2(:));
        ar2(ar2==0)=[];
 dlmwrite('testing7\leftobj.txt',ar2','-append', ...
              'newline', 'pc');   
 ...
 if(exist('testing7\centroidsequp.txt'))
 obup=csvread('testing7\centroidsequp.txt');
a=0;
...
for j=1:1:vx1(1)
    for k=1:1:2
        ...
        ar1=unique(ar1(:));
        ar1(ar1==0)=[];
 dlmwrite('testing7\upobj.txt',ar1','-append', ...
              'newline', 'pc');       
if(length(vx1)>1)    
ar2=[];
 for i=1:1:length(vx1)-1
    ...
    for j=a+1:1:b
       ...
       %disp(g);
        ...
        ar2=unique(ar2(:));
        ar2(ar2==0)=[];
 dlmwrite('testing7\upobj.txt',ar2','-append', ...
              'newline', 'pc');   
...
if(exist('testing7\mergeddownnode.txt'))
 downnode=csvread('testing7\mergeddownnode.txt');
end
if(exist('testing7\mergedupnode.txt'))
upnode=csvread('testing7\mergedupnode.txt');
end
if(exist('testing7\mergedleftnode.txt'))
leftnode=csvread('testing7\mergedleftnode.txt');
end
if(exist('testing7\mergedrightnode.txt'))
rightnode=csvread('testing7\mergedrightnode.txt');
end
if(exist('testing7\leftobj.txt'))
obleft=csvread('testing7\leftobj.txt');
end
if(exist('testing7\upobj.txt'))
obup=csvread('testing7\upobj.txt');
end
if(exist('testing7\leftnode.txt'))
...
%              vv1(1,:)=A1(:);
       ...
       fid2=fopen('testing7\creatingnetlist0.txt','a');
        if(length(valuesR)==3)
