 ...
 i1=imread('C:\Users\kalki\Pictures\New Folder\IMG_4124.jpg');
% %i1=imcrop(i1);
% %se=strel('diamond',2);
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\leftnode.txt') && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\rightnode.txt'))
...
k(i,j)=sqrt((abs(x1-x2).^2) + (abs(y1-y2).^2));
 ...
 if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\upnode.txt') && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\downnode.txt'))
...
if(r>1 && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\corresLEFT.txt'))
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\corresRIGHT.txt'))
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\corresup.txt'))
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\corresdown.txt'))
...
if(r1==1 && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\downnode.txt'))
    down=csvread('downnode.txt');
    aa=bwconncomp(i5);
L = labelmatrix(aa);
RGB = label2rgb(L);
...
%end
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\upnode.txt'))
up=csvread('upnode.txt');
%if(length(up)==1)
    aa=bwconncomp(i5);
L = labelmatrix(aa);
...
%[r c]=size(left);
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\leftnode.txt'))
left=csvread('leftnode.txt');
[r c]=size(left);
if(r==1)
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\rightnode.txt'))
right=csvread('rightnode.txt');
%if(length(right)==1)
    aa=bwconncomp(i5);
L = labelmatrix(aa);
...
if(r==1 && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\leftnode.txt'))
...
% m1=[];
 ...
 if(r1==1 && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\upnode.txt'))
 m1=csvread('upnode.txt');
% m1=m1(2,:);
 end
 if(r1~=1 && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\corresup.txt'))
 ...
 if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\centroidseqleft.txt'))
...
%        disp(g);
 ...
 if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\centroidsequp.txt'))
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\mergeddownnode.txt'))
 downnode=csvread('mergeddownnode.txt');
end
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\mergedupnode.txt'))
upnode=csvread('mergedupnode.txt');
end
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\mergedleftnode.txt'))
leftnode=csvread('mergedleftnode.txt');
end
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\mergedrightnode.txt'))
rightnode=csvread('mergedrightnode.txt');
end
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\leftobj.txt'))
obleft=csvread('leftobj.txt');
end
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\upobj.txt'))
...
for i=1:1:length(stat)
    ...
    for j=1:1:length(stat(i).PixelList)
        ...
        if(sqrt(((centroid(ground,2)-x).^2)+(centroid(ground,1)-y).^2) < 80)
            grnode=i;
            count=1;
        end
    end
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing12\netlist.txt'))
