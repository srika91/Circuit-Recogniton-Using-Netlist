 ...
 i1=imread('C:\Users\kalki\Downloads\IMG_4211.jpg');
% %i1=imcrop(i1);
% %se=strel('diamond',2);
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\leftnode.txt') && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\rightnode.txt'))
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\corresLEFT.txt'))
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\corresRIGHT.txt'))
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\leftnode.txt'))
left=csvread('leftnode.txt');
[r c]=size(left);
if(r==1)
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\rightnode.txt'))
right=csvread('rightnode.txt');
%if(length(right)==1)
    aa=bwconncomp(i5);
L = labelmatrix(aa);
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\upnode.txt') && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\downnode.txt'))
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\corresup.txt'))
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\corresdown.txt'))
...
if(r1==1 && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\downnode.txt'))
    down=csvread('downnode.txt');
    aa=bwconncomp(i5);
L = labelmatrix(aa);
RGB = label2rgb(L);
...
%end
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\upnode.txt'))
up=csvread('upnode.txt');
%if(length(up)==1)
    aa=bwconncomp(i5);
L = labelmatrix(aa);
...
CC=bwconncomp(i7);
 ...
 if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\leftnode.txt') && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\rightnode.txt'))
 if(r==1 && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\leftnode.txt'))
 m1=csvread('leftnode.txt');
% m1=m1(2,:);
end
 if( r~=1 && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\corresLEFT.txt'))
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\upnode.txt') && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\downnode.txt'))
 ...
 if(r1==1 && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\upnode.txt'))
 m1=csvread('upnode.txt');
% m1=m1(2,:);
 end
 if(r1~=1 && exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\corresup.txt'))
 ...
 if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\centroidseqleft.txt'))
obleft=csvread('centroidseqleft.txt');
[yrow ycol]=size(obleft);
...
%        disp(g);
 ...
 dlmwrite('leftobj.txt',ar2','-append', ...
        ...
        dlmwrite('leftobj.txt',obleft,'-append', ...
              'newline', 'pc');   
    end
 end
 if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\centroidsequp.txt'))
...
ar2=[];
 ...
 dlmwrite('upobj.txt',ar2','-append', ...
     ...
     dlmwrite('upobj.txt',obup,'-append', ...
              'newline', 'pc');   

 end 
 end
 
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\mergeddownnode.txt'))
 downnode=csvread('mergeddownnode.txt');
end
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\mergedupnode.txt'))
upnode=csvread('mergedupnode.txt');
end
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\mergedleftnode.txt'))
leftnode=csvread('mergedleftnode.txt');
end
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\mergedrightnode.txt'))
rightnode=csvread('mergedrightnode.txt');
end
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\leftobj.txt'))
obleft=csvread('leftobj.txt');
end
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\upobj.txt'))
...
if(exist('C:\Users\kalki\Documents\MATLAB\testingforconference\testing26\netlist.txt'))
