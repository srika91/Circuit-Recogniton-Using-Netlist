 ...
 clear all;
 close all;
 i1=imread('C:\Users\kalki\Pictures\IMG_3775.jpg');
% %i1=imcrop(i1);
% %se=strel('diamond',2);
...
for i=2:1:511
    ...
    for j=2:1:511
        if(i5(i,j)==1)
            ...
            leftnode=[i j];
            dlmwrite('testing2\leftnode.txt',leftnode,'-append', ...
             'newline', 'pc');
            end
            if(i5(i,j+1)==1 && i5(i,j-1)==0 && i5(i-1,j-1)==0  && i5(i-1,j)==0 && i5(i-1,j+1)==0 && i5(i+1,j-1)==0 && i5(i+1,j)==0 && i5(i+1,j+1)==0)
            rightnode=[i j];
            dlmwrite('testing2\rightnode.txt',rightnode,'-append', ...
             'newline', 'pc');
            end
...
if(exist('testing2\leftnode.txt') && exist('testing2\rightnode.txt'))
left=csvread('testing2\leftnode.txt');
right=csvread('testing2\rightnode.txt');
[r c]=size(left);
if(r>1)
    k=[];
...
k(i,j)=sqrt((abs(x1-x2).^2) + (abs(y1-y2).^2));
 ...
 leftu=[left(i,1) left(i,2)];
            dlmwrite('testing2\corresLEFT.txt',leftu,'-append', ...
              'newline', 'pc');

 rightu=[right(y,1) right(y,2)];
            dlmwrite('testing2\corresRIGHT.txt',rightu,'-append', ...
              'newline', 'pc');
 
 end
end
end
 if(exist('testing2\upnode.txt') && exist('testing2\downnode.txt'))
 up=csvread('testing2\upnode.txt');

down=csvread('testing2\downnode.txt');
[r1 c1]=size(up);
if(r1>1)
    k=[];
 for i=1:1:length(up)
...
k(i,j)=sqrt((abs(x1-x2).^2) + (abs(y1-y2).^2));
 ...
 [x,y]=find(k==mini);
 upu=[up(i,1) up(i,2)];
            dlmwrite('testing2\corresup.txt',upu,'-append', ...
              'newline', 'pc');

 downu=[down(y,1) down(y,2)];
            dlmwrite('testing2\corresdown.txt',downu,'-append', ...
              'newline', 'pc');
...
if(r>1 && exist('testing2\corresLEFT.txt'))
left1=csvread('testing2\corresLEFT.txt');
...
for i=1:1:length(left1)
    ...
    for j=1:1:length(statsqq)
        ...
        for k=1:1:length(statsqq(j).PixelList)
            ...
            if((x2==x1) && (y2==y1))
                %disp(y2);
                dlmwrite('testing2\mergedleftnode.txt',j,'-append', ...
              'newline', 'pc');  
            end
        end
    end
end
if(exist('testing2\corresRIGHT.txt'))
right1=csvread('testing2\corresRIGHT.txt');
...
for i=1:1:length(right1)
    ...
    for j=1:1:length(statsqq)
        ...
        for k=1:1:length(statsqq(j).PixelList)
            ...
            if((x2==x1) && (y2==y1))
                %disp(y2);
                dlmwrite('testing2\mergedrightnode.txt',j,'-append', ...
              'newline', 'pc');  
            end
        end
    end
...
if(r1>1 && exist('testing2\corresup.txt'))
up1=csvread('testing2\corresup.txt');
...
for i=1:1:length(up1)
    ...
    for j=1:1:length(statsqq)
        ...
        for k=1:1:length(statsqq(j).PixelList)
            ...
            if((x2==x1) && (y2==y1))
                %disp(y2);
                dlmwrite('testing2\mergedupnode.txt',j,'-append', ...
              'newline', 'pc');  
            end
        end
    end
end
if(exist('testing2\corresdown.txt'))
down1=csvread('testing2\corresdown.txt');
...
for i=1:1:length(down1)
    ...
    for j=1:1:length(statsqq)
        ...
        for k=1:1:length(statsqq(j).PixelList)
            ...
            if((x2==x1) && (y2==y1))
                %disp(y2);
                dlmwrite('testing2\mergeddownnode.txt',j,'-append', ...
              'newline', 'pc');  
            end
        end
    end
...
if(r1==1 && exist('testing2\downnode.txt'))
    down=csvread('testing2\downnode.txt');
    aa=bwconncomp(i5);
L = labelmatrix(aa);
RGB = label2rgb(L);
...
if(exist('testing2\leftnode.txt'))
left=csvread('testing2\leftnode.txt');
[r c]=size(left);
if(r==1)
...
if(exist('testing2\rightnode.txt'))
right=csvread('testing2\rightnode.txt');
%if(length(right)==1)
    aa=bwconncomp(i5);
L = labelmatrix(aa);
...
if(exist('testing2\leftnode.txt'))
[r c]=size(csvread('testing2\leftnode.txt'));
end
CC=bwconncomp(i7);
...
if(r==1 && exist('testing2\leftnode.txt'))
 m1=csvread('testing2\leftnode.txt');
% m1=m1(2,:);
end
 if( r~=1 && exist('testing2\corresLEFT.txt'))
     m1=csvread('testing2\corresLEFT.txt');
 end
 ...
 yy(ii,1)=dist(xd,2);
    ...
    for i=1:1:length(centroid)
        ...
        if(sq(j,1)<40 && sq(j,1)~=0)
            xl=[yy(ii,1) i];
            dlmwrite('testing2\centroidseqleft.txt',xl,'-append', ...
              'newline', 'pc');
            yy(ii,1)=i;
        end
        j=j+1;
...
% m1=[];
 if(exist('testing2\upnode.txt'))
 [r1 c1]=size(csvread('testing2\upnode.txt'));
 end
 if(r1==1 && exist('testing2\upnode.txt'))
 m1=csvread('testing2\upnode.txt');
% m1=m1(2,:);
 end
 if(r1~=1 && exist('testing2\corresup.txt'))
     m1=csvread('testing2\corresup.txt');
 end
 if(exist('m1'))
  [xm,ym]=size(m1);
    ...
    for i=1:1:length(centroid)
     ...
     for i=1:1:length(centroid)
        ...
        if(sq(jj,1)<40 && sq(jj,1)~=0)
            xu=[xx(ii,1) i];
            dlmwrite('testing2\centroidsequp.txt',xu,'-append', ...
              'newline', 'pc');
            xx(ii,1)=i;
        end
        jj=jj+1;
 ...
 if(exist('testing2\centroidseqleft.txt'))
obleft=csvread('testing2\centroidseqleft.txt');
...
ar1=[];
    for j=1:1:vxz(1)
        ...
        ar1=unique(ar1(:));
        ar1(ar1==0)=[];
 dlmwrite('testing2\leftobj.txt',ar1','-append', ...
              'newline', 'pc');       
if(length(vxz)>1)    
ar2=[];
...
%        disp(g);
        ...
        ar2=unique(ar2(:));
        ar2(ar2==0)=[];
 dlmwrite('testing2\leftobj.txt',ar2','-append', ...
              'newline', 'pc');   
 ...
 if(exist('testing2\centroidsequp.txt'))
 obup=csvread('testing2\centroidsequp.txt');
a=0;
...
for j=1:1:vx1(1)
    for k=1:1:2
        ...
        ar1=unique(ar1(:));
        ar1(ar1==0)=[];
 dlmwrite('testing2\upobj.txt',ar1','-append', ...
              'newline', 'pc');       
if(length(vx1)>1)    
ar2=[];
 for i=1:1:length(vx1)-1
    ...
    for j=a+1:1:b
       ...
       %disp(g);
        ...
        ar2=unique(ar2(:));
        ar2(ar2==0)=[];
 dlmwrite('testing2\upobj.txt',ar2','-append', ...
              'newline', 'pc');   
...
if(exist('testing2\mergeddownnode.txt'))
 downnode=csvread('testing2\mergeddownnode.txt');
end
if(exist('testing2\mergedupnode.txt'))
upnode=csvread('testing2\mergedupnode.txt');
end
if(exist('testing2\mergedleftnode.txt'))
leftnode=csvread('testing2\mergedleftnode.txt');
end
if(exist('testing2\mergedrightnode.txt'))
rightnode=csvread('testing2\mergedrightnode.txt');
end
if(exist('testing2\leftobj.txt'))
obleft=csvread('testing2\leftobj.txt');
end
if(exist('testing2\upobj.txt'))
obup=csvread('testing2\upobj.txt');
end
if(exist('testing2\leftnode.txt'))
...
for i=1:1:length(stat)
    ...
    for j=1:1:length(stat(i).PixelList)
        ...
        if(sqrt(((centroid(ground,2)-x).^2)+(centroid(ground,1)-y).^2) < 40)
            grnode=i;
            count=1;
        end
    end
 ...
 for k=1:1:r
    ...
    mtt(1,:)=mt(k,:);
     mtt(mtt(1,:)==0)=[];
        ...
        dlmwrite('testing2\netlistnew.txt',mtt,'-append','newline','pc');
    end
end 
...
%              vv1(1,:)=A1(:);
       ...
       fid2=fopen('testing2\creatingnetlist0.txt','a');
        if(length(valuesR)==3)
